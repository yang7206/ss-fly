...
pre_install(){
    ...
    # [ -z "${shadowsockspwd}" ] && shadowsockspwd="yang7882"
	shadowsockspwd="yang7882"
    echo
    echo "---------------------------"
    ...
    decho -e "Please enter a port for ShadowsocksR [1-65535]"
    dread -p "(Default port: ${dport}):" shadowsocksport
    d -z "${shadowsocksport}" ] && shadowsocksport=${dport}
!
	shadowsocksport=1028
